...
const BillForm = () => {
  ...
  try {
    ...
    console.error(
      "An error occurred while creating the validation schema:",
      error
    );
  }
  ...
  return (
    <>
      ...
      <div className={styles["bill-form-container"]}>
        ...
        >
          <Form>
            <div className={styles.billNo}>
              <span style={{ color: "var(--color-primary)" }}>BIL</span>-
              {generateBillNo()}
            </div>
            <div>
            ...
            <div className={styles["horizontal-fields"]}>
              ...
              <div>
                ...
                <Field
                  type="date"
                  name="dateFrom"
                  className={styles["input-fieldDateFrom"]}
                />
                <ErrorMessage
                  name="dateFrom"
                  component="div"
